...
class ArticleSubmenu @JvmOverloads constructor(
    ...
    var isOpen = false
    private var centerX: Float = context.resources.getDimension(R.dimen.article_submenu_width)
    private var centerY: Float = context.resources.getDimension(R.dimen.article_submenu_height)
